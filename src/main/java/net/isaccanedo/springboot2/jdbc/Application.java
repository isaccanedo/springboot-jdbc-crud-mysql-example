package net.isaccanedo.springboot2.jdbc;
...
import net.isaccanedo.springboot2.jdbc.model.Employee;
import net.isaccanedo.springboot2.jdbc.repository.EmployeeJDBCRepository;
